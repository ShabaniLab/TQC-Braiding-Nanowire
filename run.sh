...
echo "Par1,Par2,P1,P2,P3,P4,P5,P6,Vg11,Vg12,Vg21,Vg22" > $file_nanowire_states
...
python measure.py $file_particle_position $file_tqc_fusion_rules $file_tqc_fusion_channel > $file_tqc_measurements
...
echo "----- x ----- x ----- x ----- x ----- x ----- x ----- x ----- x ----- x -----"
echo "Performing CNOT Braid pattern and Nanowire movement animations..."
